...
class WeatherInKelvin(dayKelvinTemp: Int, nightKelvinTemp: Int, val isRainy: Boolean) {

    val dayTemperature: Int = dayKelvinTemp - CELSIUS_ZERO_KELVIN
    val nightTemperature: Int = nightKelvinTemp - CELSIUS_ZERO_KELVIN
